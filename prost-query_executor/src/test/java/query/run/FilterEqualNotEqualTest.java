 ...
 */
public class FilterEqualNotEqualTest extends JavaDataFrameSuiteBase implements Serializable {
	...
	private void queryOnTT(final DatabaseStatistics statistics) throws Exception {
		...
		System.out.print("FilterEqualNotEqualTest: queryTest1");
	...
	private void queryOnTT2(final DatabaseStatistics statistics) throws Exception {
		...
		final Dataset<Row> nullableActualResult = sqlContext().createDataFrame(actualResult.collectAsList(),
				actualResult.schema().asNullable());
		System.out.print("FilterEqualNotEqualTest: queryTest2");
		expectedResult.printSchema();
		expectedResult.show();
