...
//		queryOnTT(statistics, fullDataset);
	...
	private void queryOnTT(final DatabaseStatistics statistics, final Dataset<Row> fullDataset) {
		...
		//ACTUAL
		final Dataset<Row> actualResult = joinTree.compute(spark().sqlContext()).orderBy("title", "publisher", "name");
	...
	private Dataset<Row> initializeDb(final DatabaseStatistics statistics) {
		...
		t7.setO("<http://coppenrath.com/publisher>");
		...
		t9.setS("<http://coppenrath.com/publisher>");
		t9.setP("<http://example.org/name>");
		t9.setO("Coppenrath-Verlag");
...
"<http://coppenrath.com/publisher>"	| "<http://example.org/name>"			| "Coppenrath-Verlag"

"<http://example.org/book2>"		| "<http://example.org/publishedBy>"	| "<http://coppenrath.com/publisher>"
