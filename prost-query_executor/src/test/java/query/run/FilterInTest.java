...
public class FilterInTest extends JavaDataFrameSuiteBase implements Serializable {
	...
	public void queryTest2() {
		final DatabaseStatistics statistics = new DatabaseStatistics("queryTest22_db");
	...
	private Dataset<Row> initializeDb2(final DatabaseStatistics statistics) {
		spark().sql("DROP DATABASE IF EXISTS queryTest22_db CASCADE");
		spark().sql("CREATE DATABASE IF NOT EXISTS  queryTest22_db");
		spark().sql("USE queryTest22_db");
