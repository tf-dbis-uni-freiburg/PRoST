...
public class TripleTableLoader extends Loader {
	...
	public void load() {
		...
		deleteDotsFromObjects();
	}

	/**
	 * Logs important information about the triples loaded.
	 */
	...
	/**
	 * If the file contains triples of the form (<s> <p>  <o> .)
	 * with the dot at the end then object is uploaded. This is the case
	 * for literals. This method corrects this.
	 */
	public void deleteDotsFromObjects() {
	...
	public void correctTripleTables() {
		...
		String.format("DELETE FROM %s WHERE %s IS NULL or %s IS NULL or %s is NULL", name_tripletable,
