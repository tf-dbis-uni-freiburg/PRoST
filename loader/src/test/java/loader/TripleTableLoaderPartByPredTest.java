...
public class TripleTableLoaderPartByPredTest extends JavaDataFrameSuiteBase implements Serializable {
	...
	public void parsingDuplicates() throws Exception {
		...
		SparkSqlUtilities.enableSessionForPhysicalPartitioning(spark());
		tt_loader = new TripleTableLoader((System.getProperty("user.dir") +  "\\triplesWithDuplicates").replace('\\','/'), "triplesWithDuplicates_db", spark(), false, true,
				false);
		tt_loader.load();
	...
	public void parsingEmptyFile() throws Exception {
		...
		TripleTableLoader tt_loader = new TripleTableLoader((System.getProperty("user.dir") +  "\\emptyFile").replace('\\','/'), "emptyFile_db", spark(), false, true, true);
		tt_loader.load();
	}
