...
public class TripleTableLoaderDefaultPartTest extends JavaDataFrameSuiteBase implements Serializable {
	...
	public void parsingEmptyFile() throws Exception {
		...
		final TripleTableLoader tt_loader = new TripleTableLoader((System.getProperty("user.dir") + "\\target\\test_output\\emptyFile").replace('\\', '/'), "emptyFile_db", spark(), false, false, true);
		tt_loader.load();
	}
